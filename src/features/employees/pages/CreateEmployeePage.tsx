    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-lg shadow-md p-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Додати працівника</h1>
          <p className="text-gray-600 mb-6">Введіть інформацію про нового працівника</p>
          ...
          {createEmployee.isError && (
            <div className="mb-4 p-3 bg-red-100 border border-red-400 text-red-700 rounded">
              Помилка: {(createEmployee.error as any)?.response?.data?.message || 'Невідома помилка'}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-3 pt-4">
              ...
              >
                {createEmployee.isPending ? 'Збереження...' : 'Додати'}
              </button>
              <button 
                type="button" 

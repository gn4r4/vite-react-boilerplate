  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    updateEmployee.mutate({
      ...
      data: payload as unknown as Partial<IEmployee>,
        ...
        onError: (error: any) => {
            setFormErrors(error?.response?.data?.message || 'Помилка при оновленні');
        }
    });
  };
    ...
    return (
      <div className="flex justify-center items-center h-screen bg-gray-50/50">
        <div className="flex flex-col items-center gap-3">
             ...
             <div className="text-gray-500 font-medium">Завантаження даних працівника...</div>
        </div>
      </div>
    );
  }
        ...
        <div className="flex items-center gap-4 mb-8">
           ...
           <div className="flex-1 flex justify-between items-center">
             <div>
                ...
                <p className="text-slate-500">Оновлення інформації про працівника</p>
             </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden p-6 md:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="flex gap-4 pt-4 border-t border-slate-100">
              ...
              >
                {updateEmployee.isPending ? 'Збереження...' : 'Зберегти зміни'}
              </button>
            </div>
          </form>
        </div>

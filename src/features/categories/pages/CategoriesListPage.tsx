  ...
  const processedCategories = useMemo(() => {
    ...
    if (sortConfig) {
      result.sort((a, b) => {
        ...
        // Порівняння чисел (якщо раптом знадобиться, залишаємо логіку)
    ...
    return (
      <div className="flex items-center justify-center h-screen bg-gray-50">
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="text-gray-500 font-medium">Завантаження категорій...</div>
        </div>
      </div>
    );
    ...
    return (
      <div className="flex items-center justify-center h-screen bg-gray-50">
        <div className="bg-white p-6 rounded-xl shadow-lg border border-red-100 text-center">
          ...
          <p className="text-red-500">Не вдалося завантажити категорії.</p>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-gray-50/50 p-6 md:p-10">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <h1 className="text-3xl font-extrabold text-slate-800 tracking-tight">Категорії книг</h1>
            <p className="text-slate-500 mt-1">
              Знайдено {processedCategories.length} із {categories?.length || 0} записів
            </p>
          </div>

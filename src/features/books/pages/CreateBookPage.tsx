    ...
    <div className="min-h-screen bg-gray-50/50 p-6 md:p-10 flex justify-center">
      <div className="w-full max-w-3xl">
        ...
        <div className="flex items-center gap-4 mb-8">
           ...
           <div>
             <h1 className="text-3xl font-extrabold text-slate-800 tracking-tight">Нова книга</h1>
             <p className="text-slate-500">Заповніть форму для додавання книги у фонд</p>
           </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden p-6 md:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="flex gap-4 pt-4 border-t border-slate-100">
              ...
              >
                {createBook.isPending ? 'Збереження...' : 'Створити книгу'}
              </button>
            </div>
          </form>
        </div>
